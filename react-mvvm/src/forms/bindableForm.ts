...
export class BindableForm<TDto, TSchema> {
    ...
    constructor(private fieldDefinitions: { [P in keyof TSchema]: BindableFormFieldDefinition<TDto, TSchema[P]> }, private dtoAccessor: () => TDto) {
        const fields: any = {};
